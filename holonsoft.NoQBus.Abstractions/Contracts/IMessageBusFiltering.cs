...
namespace holonsoft.NoQBus.Abstractions.Contracts
{
	...
	{
		public Task<Guid> AddRequestFilter<TRequest>(Func<TRequest, Task<bool>> filter) where TRequest : IRequest;
		public Task RemoveRequestFilter(Guid requestFilterId);
		public Task<Guid> AddResponseFilter<TResponse>(Func<IEnumerable<TResponse>, Task<IEnumerable<TResponse>>> filter) where TResponse : IResponse;
		public Task RemoveResponseFilter(Guid responseFilterId);

		public Task<Guid> AddRequestFilter<TRequest>(IRequestFilter<TRequest> filter) where TRequest : IRequest
		...
		public Task<Guid> AddRequestFilter<TRequest>(Func<IRequestFilter<TRequest>> filterFactory) where TRequest : IRequest
		...
		public Task<Guid> AddResponseFilter<TResponse>(IResponseFilter<TResponse> filter) where TResponse : IResponse
		...
		public Task<Guid> AddResponseFilter<TResponse>(Func<IResponseFilter<TResponse>> filterFactory) where TResponse : IResponse
